...
- create the hidden file [`.Rprofile`](https://raw.githubusercontent.com/brdauria/codingclubuc3m_talk/master/docs/files/.Rprofile) in the project directory  
   ...
   options(
      ...
      blogdown.base.url = '{{ site.baseurl }}/assets/figures/'
   )
...
A new file named `2019-03-25-hello-jekyll.Rmd`   
...
- in the folder `_include` create [`mathjax.html`]()
...
- in the folder `_layout` create [`mpost.html`]()
